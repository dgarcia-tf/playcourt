...
export const MAX_TOTAL_INLINE_NOTICE_IMAGE_SIZE = MAX_INLINE_NOTICE_IMAGE_SIZE * 2;
export const MAX_NOTICE_RICH_CONTENT_LENGTH = 12000;
export const MAX_NOTICE_RICH_CONTENT_WITH_IMAGES = 600000;
export const NOTICE_INLINE_IMAGE_DATA_URL_PATTERN = /^data:image\/[a-z0-9.+-]+;base64,/i;
export const NOTICE_INLINE_IMAGE_SRC_REGEX = /<img[^>]+src\s*=\s*["']([^"']+)["'][^>]*>/gi;
...
export const TOURNAMENT_MATCH_TYPE_LABELS = TOURNAMENT_MATCH_TYPE_OPTIONS.reduce((map, option) => {
  map[option.value] = option.label;
  return map;
}, {});

export const MATCH_FORMAT_LABELS = CATEGORY_MATCH_FORMAT_OPTIONS.reduce((map, option) => {
  map[option.value] = option.label;
  return map;
}, {});
...
export const CATEGORY_COLOR_PALETTE = Object.freeze(['#2563EB', '#9333EA', '#F97316', '#059669']);
